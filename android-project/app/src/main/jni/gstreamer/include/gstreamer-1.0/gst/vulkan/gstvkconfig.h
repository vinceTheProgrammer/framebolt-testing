...
#define GST_VULKAN_HAVE_WINDOW_XCB 0
#define GST_VULKAN_HAVE_WINDOW_WAYLAND 0
#define GST_VULKAN_HAVE_WINDOW_COCOA 0
#define GST_VULKAN_HAVE_WINDOW_IOS 0
#define GST_VULKAN_HAVE_WINDOW_WIN32 0
#define GST_VULKAN_HAVE_WINDOW_ANDROID 1
#define GST_VULKAN_HAVE_VIDEO_EXTENSIONS 0
